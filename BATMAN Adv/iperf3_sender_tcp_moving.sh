...
then
	...
	echo "Ex : ./iperf3_sender_tcp_moving.sh 2 169.254.0.1 3              #recieving Moving TCP @ 2 with IP address 169.254.0.1 for Test3"
	exit
fi

#Run it 10 times : cancelled (do it 10 times manually)
#for i in `seq 1 1 10`
#do
	...
	iperf3 bat0 -c $2 -i 15 -t 15 -f KBytes >> moving"$1"ClientTCP"$2"
